...
export const TypingComponent = () => {
  ...
  const messages = [
    ...
    "&#128197; <span class='text-pink-500 font-extrabold'>On Day 4</span>, it's time to finalise and host your website. Review and troubleshoot your website, preparing it for deployment. Understand the intricacies of <span class='text-pink-500 font-extrabold'>hosting and domains</span>, and discover how to make your website publicly accessible using <a href='#' class='text-blue-500 font-extrabold underline'>Netlify</a>. Engage in additional site improvements and deployments, all while reflecting on your learning journey and discussing future paths in web development.",
